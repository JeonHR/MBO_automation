...
##################################################
    print "### delete macmini org pathloss files"."\n"; # verify for value
    !system('del '.@drive_map[$site_val-100].':\pathloss_r2.txt');
	 print "### delete macmini org pathloss files"."\n"; # verify for value
    !system('del '.@drive_map[$site_val-100].':\pathloss_r2_TANA_site1.txt');
	 print "### delete macmini org pathloss files"."\n"; # verify for value
    !system('del '.@drive_map[$site_val-100].':\pathloss_r2_BAZA_site1.txt');	
    print "### rename local pathloss files"."\n"; # verify for value
    !system('ren pathloss_r2_s'.$site.'.txt pathloss_r2.txt');
    print "### local pathloss.txt -> mac pathloss.txt"."\n"; # verify for value
    !system('copy pathloss_r2.txt '.@drive_map[$site_val-100].':\ /y');
